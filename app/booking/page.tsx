    ...
    <>
      ...
      <main className="md:hidden min-h-dvh bg-sand pb-20">
        <div className="bg-ocean px-4 pt-5 pb-6">
          <h1 className="font-serif text-xl text-white font-semibold">Booking</h1>
          <p className="text-xs text-white/50 mt-1">Kelola reservasi kamu</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-20 gap-3 px-4">
          ...
          <p className="text-sm text-muted text-center">Halaman booking akan segera hadir</p>
        </div>
        <BottomNav />
      </main>
      ...
      <main className="hidden md:block min-h-dvh bg-sand">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20 flex flex-col items-center gap-4">
          ...
          <h1 className="font-serif text-2xl text-dark font-semibold">Booking</h1>
          <p className="text-sm text-muted">Halaman booking akan segera hadir</p>
        </div>
      </main>
    </>
  );
